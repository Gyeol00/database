...
INSERT INTO `User` (`userId`, `userName`, `userBirth`, `userGender`, `userHp`, `userEmail`, `userPoint`, `userLevel`, `userAddr`, `userRegDate`) 
VALUES 
...
INSERT INTO `Point` (`userId`, `point`, `pointDesc`, `pointDate`)
VALUES
...
INSERT INTO `Seller` (`sellerNo`, `sellerBizName`, `sellerPhone`, `sellerManager`, `sellerAddr`)
VALUES
...
INSERT INTO `Category` (`cateNo`, `cateName`)
VALUES
(10, '여성의류패션'),
(11, '남성의류패션'),
(12, '식품·생필품'),
...
INSERT INTO `Order` (`orderNo`, `userId`, `orderTotalPrice`, `orderAddr`, `orderStatus`, `orderDate`)
VALUES
...
SELECT
	...
	IFNULL(SUM(p.`point`), 0) AS `적립포인트 총합`
FROM `user` u
